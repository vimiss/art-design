			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/periodApply/listExpiredApply" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-sm-3">
									<label>投资人姓名：</label>
								...
								<div class="col-xs-12 ">
									<table class="table table-striped table-bordered table-hover RtableStriped RtableStropSOS">
										...
										<tr role="row">
											...
											<th class="center" >驳回意见</th>
											<th class="center" >失效原因</th>
										...
										<#if periodApplyList>
											...
											<tr>
												...
												<td class="center">
													<div>${periodApply.applyOpinion?default("--")}</div>
												</td>
												<td class="center">
													<div><@option name="period_fail_type_param" status="1" type="3" value="${periodApply.applyFailReason}" /></div>
												</td>
												<td class="center">
										...
										<#else>
											<tr align="center">
												...
												<@shiro.hasRole name = "admin">
												<td colspan="17"><font color="red" size="4">没有查询到数据！</font></td>
												</@shiro.hasRole>
											</tr>
										</#if>
										</tbody>
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/periodApply/listExpiredApply">
