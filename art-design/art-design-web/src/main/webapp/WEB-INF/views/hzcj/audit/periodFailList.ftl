...
<#assign active_menu_name = "分期募集失败管理">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/itemPeriodAudit/listRaiseFailPeriod" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-sm-3">
									<label>项目标题：</label>
								...
								<div class="col-xs-12 ">
									<span onclick="queryPeriodApply()" class="BtnNormalSu default-btn btn-blue" >查 看 订 单</span>
									<table class="table table-striped table-bordered table-hover RtableStriped RtableStropSOS">
										...
										<#if itemPeriodAuditList>
											...
											<tr>
												...
												<td class="center">
													<div>${itemPeriodAudit.itemPeriod.perMinFee}%~${itemPeriodAudit.itemPeriod.perMaxFee}%</div>
												</td>
												<td class="center">
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/itemPeriodAudit/listRaiseFailPeriod">
