...
<div class="modal-dialog modal-lg1" role="document" style="width:1500px;">
	<div class="modal-content">
		...
		<form role="form" class="form-group" action="${ctx}/recruit/update" method="POST" id="addNoticeForm" >
			...
			<div class="container-fluid">
				<div class="row">
					 <div class=" Mylist clearfix">
						<div class="col-xs-12 MylistCol">
							...
							<select class="chosen-select AceSelect" name="infoType" id="infoType" >
								...
								<#if iemFences?exists>
									<#list iemFences as opt>
										<option value="${opt.fenceTableCode}">${opt.fenceName}</option>
									</#list>
								</#if>
						     </select>
					    ...
					    <div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
							  <input type="text" class="InputName1" name="infoTitle" id="infoTitle"  maxlength="20"  placeholder="">
							  	<button type="button" class="btn btn-primary" id="upLoadToServer" >添加标题图片</button>
								<span id="checkStudentName" class="light-red"></span>
							</div>
						</div>
					...
					<div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
								<img style="max-height: 60px; max-width: 250px;" id="titlePic" alt="" src="">
					...
					<div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
							  <input type="text" class="InputName1" name="infoDesc" id="infoDesc"  maxlength="20"  placeholder="">
								<span id="checkStudentName" class="light-red"></span>
							</div>
						</div>
				...
				<div class="col-xs-12">
					<div class="form-group">
						<label class="control-label col-xs-2"><span style='color: red'>*</span>内容：</label>
						<div class="col-xs-8 no-padding-left" style="z-index:10; width: 75%;">
						 	<script id="infoContent"  name ="infoContent" type="text/plain" style="width:1150px;height:700px;">${spreadInfo.infoContent}
						 	</script>
						</div>
					</div>
				</div>
		...
		<div class="modal-footer">
			<div class="text-center">
			       <a href="javascript:;" style="color: #3eafe0" class="default-btn btn-orange noBorder marginLR20" onclick="goAddNotice1(${item.itemId});">添加栏目</a>
			       <a href="javascript:;" onclick="submitItemNotice();" class="default-btn btn-orange noBorder marginLR20">保 存</a>
