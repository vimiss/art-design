...
<#assign active_menu_name = "分期已结算管理">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/itemPeriodAudit/listCompletePeriod" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-sm-3">
									<label>项目标题：</label>
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/itemPeriodAudit/listCompletePeriod">
