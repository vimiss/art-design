			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/assets/fp/auditList" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								 <div class="col-sm-4">
										<label>审核状态：</label>
								 ...
								 <div class="col-sm-6">
										<label>申请时间：</label>
										<input id="start_time" style="width:160px;" name="startTime" value="${assetsVo.startTime}" class="Wdate WdateInput1" type="text" onfocus="var end_time=$dp.$('end_time');WdatePicker({onpicked:function(){end_time.focus();},dateFmt:'yyyy-MM-dd',maxDate:'#F{$dp.$D(\'end_time\')}',isShowClear:true,isShowOthers:false,qsEnabled:false})">
										至
										<input id="end_time" style="width:160px;" name="endTime" value="${assetsVo.endTime}" class="Wdate WdateInput1" type="text" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'start_time\')}',dateFmt:'yyyy-MM-dd',isShowClear:true,isShowOthers:false,qsEnabled:false})">
									...
									<table class="table table-striped table-bordered table-hover RtableStriped RtableStropSOS">
										...
										<#if fpList>
											...
											<tr>
												...
												<td class="center">
													<div class="aName">${fp.auditUsername?default("--")}</div>
												</td>
												<td class="center">
													<div class="aName">
												...
												<td class="center">
													<div class="aName">
													<#if fp.assetAuditTime>
														<@date_sub value='${fp.assetAuditTime?string("yyyy-MM-dd HH:mm:ss")}' />
													<#else>
														--
													</#if>	
													</div>
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/assets/fp/auditList">
...
<script type="text/javascript">
	...
	function get(){
		...
		$('#catalog_list_modal').html("加载中...").load(ctx+'/assets/fp/get?id='+assetIdRadio+'&r='+Math.random(),function(){
