...
<#assign active_menu_name = "分期审核通过管理">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/itemPeriodAudit/listPassPeriodAudit" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-sm-3">
									<label>项目标题：</label>
							...
							<div class="col-xs-12" style="margin-top:10px;">
								<div class="col-sm-3">
									<label>分期状态：</label>
							       	<select class="chosen-select AceSelect" name="perStatus" id="perStatus">
										<@option name="period_status_param" status="1" value="${itemPeriodAuditVo.itemPeriod.perStatus}" show="01,02,03,06"/>
									</select>
								</div>
								<div class="col-sm-6">
										<label>创建日期：</label>
								...
								<div class="col-xs-12 ">
									<span onclick="queryPeriodDelay()" class="BtnNormalSu default-btn btn-blue" >延 期</span>
									...
									<table class="table table-striped table-bordered table-hover RtableStriped RtableStropSOS">
										...
										<#if itemPeriodAuditList>
											...
											<tr>
												<td class="center">
													<div>
														<input name="auditIdRadio" type="radio" value="${itemPeriodAudit.auditId?if_exists}">
													</div>
												</td>
												<td class="center">
													<div>
												...
												<td class="center">
													<div>
														<@date_sub value='${itemPeriodAudit.itemPeriod.perOverTime?string("yyyy-MM-dd HH:mm:ss")}' />
													</div>
												</td>
												<td class="center">
													<div><@option name="yes_no_type_param" type="3" status="1" value="${itemPeriodAudit.itemPeriod.perDelay}"/></div>
												</td>
												<td class="center">
													<div class="aName">
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/itemPeriodAudit/listPassPeriodAudit">
