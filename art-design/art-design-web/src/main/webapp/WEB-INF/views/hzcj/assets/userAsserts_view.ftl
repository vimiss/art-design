...
<div class="modal-dialog modal-lg1" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">资产证明信息</h4>
		</div>
				...
				<!-- 文本内容开始 -->
							<div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
										${userAssets.assetTime?string("yyyy-MM-dd HH:mm:ss")}
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
							 ...
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									${userAssets.assetAuditTime?string("yyyy-MM-dd HH:mm:ss")}
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<@option name="audit_status_param" status="1" type="3" value="${userAssets.assetAuditStatus}"/>
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
