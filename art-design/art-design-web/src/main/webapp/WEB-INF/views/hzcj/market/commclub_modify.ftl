...
<div class="modal-dialog modal-lg1" role="document">
	<div class="modal-content">
		...
		<form id="msgpushForm" name="msgpushForm" method="post" >
			<!-- 文本内容开始 -->
	                      		<input type="hidden" name="clubId" id="clubId" value="${commClub.clubId}"/>
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input name="clubName" id="clubName" type="text" class="InputName1" value="${commClub.clubName}"   placeholder="限20字符(中文字符长度为2)">
								</div>
							</div>
							<div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input type="text" name="clubCode" id="clubCode" class="InputName1" value="${commClub.clubCode}"  placeholder="限数字，不能重复" >
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input name="clubDesc" id="clubDesc" type="text" class="InputName1"   value="${commClub.clubDesc}" placeholder="限100字符(中文字符长度为2)">
							 ...
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<img style="max-height: 60px; max-width: 250px;" id="titlePic" src="${commClub.clubUrl?if_exists}">
									<input name="clubUrl" id="clubUrl" type="hidden" value="${commClub.clubUrl?if_exists}">
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
	                      	...
	                      	<!-- 文本内容结束 -->
	                      	<input type="hidden" name="modifyCommClub" value="${modifyCommClub?if_exists}" />
		</form>
		</div>
		...
		$.ajax({
			...
			success:function(data) {
				if(data.result == 'success'){
					Modal.alert({msg:"修改类别成功",okCallback:function(){
					...
					$("input[name='modifyCommClub']").val(data.newTokenName);
