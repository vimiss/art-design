							...
							<input type="hidden" name="commId" id="commId" />
	                      	<div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input type="text" name="commNum" id="commNum" class="InputName1"   placeholder="限数字，不能重复" >
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input name="commName" id="commName" type="text" class="InputName1"  maxlength="40"  placeholder="限40字符(中文字符长度为2)">
							...
							<script type="text/plain" id="uploadImg" style="display:none"></script>
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									...
									<input name="commUrl" id="commUrl" type="hidden" >
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<select class="chosen-select AceSelect" name="commType" id="commType">
											<@option name="comm_type_param" status="1" />
										</select>
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<select class="chosen-select AceSelect" name="commClub" id="commClub">
											<@option name="comm_club_param" status="1"  method="getCommClubAsOption"/>
										</select>
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<script id="infoContent"  name ="commDesc" type="text/plain" style="margin-right:15px;height:700px;">
						 				</script>
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input name="commAmount" id="commAmount" type="text" class="InputName1"   placeholder="0或正整数">
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input name="commRemNum" id="commRemNum" type="text" class="InputName1"   placeholder="0或正整数">
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input name="commConNum" id="commConNum" type="text" class="InputName1"   placeholder="0或正整数">
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input name="commPoint" id="commPoint" type="text" class="InputName1"    placeholder="0或正整数">
								</div>
							</div>
							 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
								...
								<div class="pull-left MylistRight">
									<input name="commRemark" id="commRemark" type="text" class="InputName1"  maxlength="100"  placeholder="限100字符(中文字符长度为2)">
								</div>
							</div>
							 	 <div class="col-xs-12 MylistCol">
								<div class="pull-left MylistLeft">
	                      	...
	                      	<!-- 文本内容结束 -->
	                      	<input type="hidden" name="addCommodity" value="${addCommodity?if_exists}" />
		</form>
		</div>
		...
		$.ajax({
			...
			success:function(data) {
				if(data.result == 'success'){
					Modal.alert({msg:"新增商品成功",okCallback:function(){
					...
					$("input[name='addCommodity']").val(data.newTokenName);
