			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/assets/user/list" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								 <div class="col-sm-6">
										<label>申请时间：</label>
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/assets/user/list">
...
<script type="text/javascript">
	...
	function modify(){
		...
		$('#catalog_list_modal').html("加载中...").load(ctx+'/assets/user/modify/page?id='+assetIdRadio+'&r='+Math.random(),function(){
