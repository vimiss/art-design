...
<#include "commons/head.ftl">
                    	...
                    	<form id="msgpushForm" name="msgpushForm" method="post">
	                      	...
	                      	<div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input type="hidden" id="optionId" name="optionId" value="${opt.optionId}">
										<input type="hidden" id="librId" name="librId" value="${opt.librId}">
										<input type="text" id="librCode" name="librCode" class="InputName1" value="${opt.librCode}" maxlength="1"  >
							 ...
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input name="optionContent" id="optionContent" type="text" class="InputName1" value="${opt.optionContent}" maxlength="100"  placeholder="限100字符(中文字符长度为2)">
							...
							<div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input name="optionMark" id="optionMark" type="text" class="InputName1" value="${opt.optionMark}"  maxlength="2"  placeholder="1~99之间的数字">
									<span id="checkOptionMark" class="red" style="margin-left: 20px;"></span>
								</div>
							</div>
							<input type="hidden" name="modifyOption" value="${modifyOption?if_exists}" />
	                      	<!-- 文本内容结束 -->
	                  </form>
	...
	function modify(){
		$.ajax({
			type : "POST",
			url : ctx + "/question/token/option/modify",
			...
			success:function(data) {
				if(data.result == 'success'){
					Modal.alert({msg:"题项修改成功",okCallback:function(){
