...
<div class="modal-dialog modal-lg1" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">资产证明审核</h4>
		</div>
				...
				<!-- 文本内容开始 -->
							 <div class="col-xs-12 MylistCol">
								...
								<div class="pull-left MylistRight">
									<input type="hidden" name="assetId" value="${userAssets.assetId}">
									<input type="hidden" name="userId" value="${userAssets.userId}">
							...
							<input type="hidden" name="modifyUserAssets" value="${modifyUserAssets?if_exists}" />
	                      	<!-- 文本内容结束 -->
		</form>
		</div>
