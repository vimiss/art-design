...
<div class="modal-dialog modal-lg1" role="document" style="width:1500px;">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">栏目编辑</h4>
		</div>
		<div class="modal-body">
		<form role="form" class="form-group" action="${ctx}/recruit/update" method="POST" id="addNoticeForm" >
		<input type="hidden" name="addNotice" value="${addNotice?if_exists}" />
			<div class="container-fluid">
				<div class="row">
					 <div class=" Mylist clearfix">
						...
						<div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
					            <select class="chosen-select AceSelect" name="infoType" id="infoType">
									<@option name="fence_type_param" status="1" method="getFenceAsOption"/>
								</select>
					    ...
					    <div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
							  <input type="text" class="InputName1" name="infoTitle" id="infoTitle"  value=""  maxlength="20"  placeholder="">
					...
					<div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
							  <input type="text" class="InputName1" name="infoDesc" id="infoDesc"  value="" maxlength="20"  placeholder="">
								<span id="checkStudentName" class="light-red"></span>
							</div>
						</div>
					...
					<div class="col-xs-12 MylistCol">
							...
							<div class="pull-left MylistRight">
							 <select class="chosen-select AceSelect" name="itemIfList" >
								...
								<span id="ifList" class="light-red"></span>
							</div>
						</div>
				...
				<div class="col-xs-12 MylistCol">
						...
						<div class="pull-left MylistRight">
						 	<script id="infoContent"  name ="infoContent" type="text/plain" style="margin-right:15px;height:700px;">
						 	</script>
						</div>
					</div>
		...
		<div class="modal-footer">
			<div class="text-center">
				<a onclick="submitNotice();" class="default-btn btn-orange marginLR20">保 存</a>
