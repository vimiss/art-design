			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/sms/fail/list" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-xs-12 ">
									<div class="col-sm-3">
								...
								<div class="col-xs-12 ">
									<table class="table table-striped table-bordered table-hover RtableStriped RtableStropSOS">
										...
										<tbody>
										<#if smsFailListByPage?if_exists>
											<#list smsFailListByPage as smsFail>
											<tr>
												<td class="center">
													<div class="aName">${smsFail_index+1+(pageView.pageNow-1)*pageView.pageSize}</div>
												</td>
												<td class="center">
													<div class="aName">${smsFail.smsMobile?default("--")}</div>
												</td>
												<td class="center">
													<div class="aName"><@times value="${smsFail.platSendTime}" /></div>
												</td>
												<td class="center">
													<div class="aName"><@times value="${smsFail.platRealSendTime}" /></div>
												</td>
												<td class="center">
													<div class="aName"><@times value="${smsFail.scanSendTime}" /></div>
												</td>
												<td class="center">
													<div class="aName">${smsFail.smsSeqId?default("--")}</div>
												</td>
												<td class="center ">
													<div class="aName">${smsFail.batchCode?default("--")}</div>
												</td>
												<td class="center">
													<div class="aName">
														<@option name="sms_send_type_param" status="1" type="3" value="${smsFail.sendStatus}"/>
													</div>
												</td>
												<td class="center">
													<div class="aName">
														<@option name="sms_type_param" status="1" type="3" value="${smsFail.smsType}"/>
													</div>
												</td>
												<td class="center ">
													<div class="aName">${smsFail.errorCode?default("--")}</div>
												</td>
												<td class="center">
													<div class="aName">
														<@option name="sms_priority_type_param" status="1" type="3" value="${smsFail.smsPriority}" />
													</div>
												</td>
												<td class="center">
													<div class="aName">
														<@option name="sms_deal_status_param" status="1" type="3" value="${smsFail.dealStatus}"/>
													</div>
												</td>
												<td class="center ">
													<div class="aName">
														<a class="btn btn-primary btn-sm" onclick="querySmsFailContent('${smsFail.smsContent}');">查看</a>
													</div>
												</td>
											</tr>
											</#list>
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/sms/fail/list?active=${active}">
...
<!-- 课程包详情弹层 -->
<div class="modal fade" id="fail_content_modal" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-body">
			<div class="col-xs-12">
				<div class="col-xs-12">
					<div class="col-sm-12">
						<label>消息内容：</label>
						<textarea class="InputName4" readonly="readonly" id="contentFailModal"></textarea>
					</div>
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	...
	function querySmsFailContent(smsContent) {
		$("#contentFailModal").html(smsContent);
		$("#fail_content_modal").modal({
