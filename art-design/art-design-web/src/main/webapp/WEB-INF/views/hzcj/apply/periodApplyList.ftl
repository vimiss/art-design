...
<#assign active_menu_name = "管理员预约管理">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content ">
						...
						<form action="${ctx}/periodApply/list" method="POST" id="queryForm">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<div class="col-sm-3">
									<label>投资人姓名：</label>
								...
								<div class="col-sm-3">
									<label>申请状态：</label>
									<select class="chosen-select AceSelect" name="applyStatus" >
											<@option name="apply_status_param" status="1" value="${periodApplyVo.applyStatus}"/>
									</select>
								</div>
								<div class="col-sm-6">
										<label>申请时间：</label>
								...
								<div class="col-xs-12 ">
									<span onclick="modifyApply();" class="BtnNormalSu default-btn btn-blue">修 改</span>
									...
									<table class="table table-striped table-bordered table-hover RtableStriped RtableStropSOS">
										...
										<#if periodApplyList>
											...
											<tr>
												...
												<td class="center">
													<div>${periodApply.applyUserName?default("--")}</div>
												</td>
												<@shiro.hasRole name="admin">
												<td class="center">
										...
										<#else>
											<tr align="center">
												...
												<td colspan="13"><font color="red" size="4">没有查询到数据！</font></td>
												</@shiro.lacksRole>
												<@shiro.hasRole name = "admin">
												<td colspan="15"><font color="red" size="4">没有查询到数据！</font></td>
												</@shiro.hasRole>
											</tr>
										</#if>
										</tbody>
...
<form id="lastQueryForm" method="post" name="lastQueryForm" action="${ctx}/periodApply/list">
 	<input type="hidden" id="oldPageNow" name="pageNow" value="${pageView.pageNow}" />
	<input type="hidden" name="applyStatus" value="${periodApplyVo.applyStatus}" />
