...
function(a, b) {
	...
	layer.restore = function(a) {
		...
		f.rescollbar(a),
		$('#t1003-dialog-message').width(parseFloat(d[0]));
		$('#t1003-dialog-message').height(parseFloat(d[1])-74);
	},
	layer.full = function(a, b) {
		...
		100),
		$('#t1003-dialog-message').width(d.width() - i);
		$('#t1003-dialog-message').height(d.height() - i);
	},
	...
	f.run = function() {
		...
		d = c(a),
		g.html = c("html"),
		layer.use("../layer/skin/layer.css"),
		c.layer = function(a) {
			var b = new h(a);
			return b.index
		},
		(new Image).src = layer.path + "../layer/skin/default/xubox_ico0.png"
	},
